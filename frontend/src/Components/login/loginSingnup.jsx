...
import eyeClose from '../../assets/imgsCssfile/eyeClose.png';
import eyeOpen from '../../assets/imgsCssfile/eyeOpen.png';
...
export default function LoginSignup(props) {
  ...
  // false
  const [isLoginFormHidden, setIsLoginFormHidden] = useState(props.isLoginForm);
  //  true only login 
  const [isCreateAccountFormHidden, setIsCreateAccountFormHidden] = useState(props.isLoginForm);
